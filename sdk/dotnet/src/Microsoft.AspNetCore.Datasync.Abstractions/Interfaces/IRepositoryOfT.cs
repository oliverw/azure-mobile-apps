...
namespace Microsoft.AspNetCore.Datasync
{
    ...
    public interface IRepository<TEntity, TVersion> where TEntity : ITableData<TVersion>
    {
        /// <summary>
        ...
        /// <exception cref="RepositoryException">if an error occurs in the data store.</exception>
        Task DeleteAsync(string id, TVersion version = default, CancellationToken token = default);
        ...
        /// <exception cref="ConflictException">if the entity version does not match the provided version</exception>
        /// <exception cref="RepositoryException">if an error occurs in the data store.</exception>
        Task ReplaceAsync(TEntity entity, TVersion version = default, CancellationToken token = default);
    }
}
